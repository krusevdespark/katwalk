...
*
*/
public class PersonProfileItemsAdapter extends BaseAdapter {
	...
	// Default Constructor
	public PersonProfileItemsAdapter(Context context, ImageLoader imageLoader, DisplayImageOptions options, LinkedHashSet<ItemBasic> myItems) {
	...
	public PersonProfileItemsAdapter(Context context, ImageLoader imageLoader, DisplayImageOptions options, LinkedHashSet<ItemBasic> myItems, int selectedCategoryId) {
	...
	// to it
	public PersonProfileItemsAdapter(Context context, ImageLoader imageLoader, DisplayImageOptions options, LinkedHashSet<ItemBasic> myItems, CharSequence autocompleteInput) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		imageLoader.displayImage(C.API.WEB_ADDRESS + C.API.IMAGES_ITEMS_FOLDER_THUMBNAIL + itemImages.get(position), holder.iMyItemsFeedItemImage, options);
