...
public class PersonProfileFollowingAdapter extends BaseAdapter {
	...
	public PersonProfileFollowingAdapter(Context context, ArrayList<String> itemNames, ArrayList<String> itemBrands, ArrayList<Integer> itemPrices, ArrayList<Double> itemRatings, ArrayList<String> itemsBoughtFrom, ArrayList<String> itemImagePaths, ArrayList<Integer> itemIds, ArrayList<Integer> itemRatingsCount){
