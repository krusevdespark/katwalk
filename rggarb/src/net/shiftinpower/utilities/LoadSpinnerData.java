...
public class LoadSpinnerData {
	...
	public static void loadSpinnerData(Context context, ArrayList<String> array, Spinner spinner) {
		...
		ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(context, R.drawable.simple_spinner_item, array);

		// Drop down layout style - list view with radio button
		dataAdapter.setDropDownViewResource(R.drawable.simple_spinner_dropdown_item);
