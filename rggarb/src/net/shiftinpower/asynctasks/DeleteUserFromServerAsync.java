...
public class DeleteUserFromServerAsync extends AsyncTask<String, String, String> {
	...
	public DeleteUserFromServerAsync(Context context, OnUserDeletionListener listener, String userToBeDeleted, String userAvatarPath,
			boolean deleteUserItemImagesAsWell) {
