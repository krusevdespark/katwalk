...
public class MyProfileComments extends RggarbSlidingMenu {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bEmptyMyProfileCommentsSearchItems.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent searchItems = new Intent(MyProfileComments.this, SearchItems.class);
		...
		bEmptyMyProfileCommentsVisitItemsFeed.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent visitItemsFeed = new Intent(MyProfileComments.this, Home.class);
