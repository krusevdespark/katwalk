...
public class MyProfileFollowing extends RggarbSlidingMenu {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bEmptyMyProfileFollowingsSearchItems.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent searchItems = new Intent(MyProfileFollowing.this, SearchItems.class);
		...
		bEmptyMyProfileFollowingsVisitItemsFeed.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent visitItemsFeed = new Intent(MyProfileFollowing.this, Home.class);
