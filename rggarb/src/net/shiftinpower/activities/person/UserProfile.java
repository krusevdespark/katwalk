...
public class UserProfile extends PersonProfile implements OnFriendRequestSendListener, OnFriendRequestCancelListener, OnRemoveFriendListener,
	...
	public void onFriendRequestCancelFailure() {
		katwalk.toastMaker.toast(net.shiftinpower.activities.person.UserProfile.this, C.Errorz.FRIEND_REQUEST_NOT_CANCELLED, Toast.LENGTH_SHORT);
	}

	@Override
	public void onFriendRequestAcceptSuccess() {
		katwalk.toastMaker.toast(net.shiftinpower.activities.person.UserProfile.this, C.Confirmationz.FRIEND_REQUEST_ACCEPTED, Toast.LENGTH_SHORT);
		super.identifyUser(extrasObtained);
	...
	public void onFriendRequestAcceptFailure() {
		...
		katwalk.toastMaker.toast(net.shiftinpower.activities.person.UserProfile.this, C.Errorz.FRIEND_REQUEST_NOT_ACCEPTED, Toast.LENGTH_SHORT);

	}

	@Override
	public void onFriendRequestRejectSuccess() {
		katwalk.toastMaker.toast(net.shiftinpower.activities.person.UserProfile.this, C.Confirmationz.FRIEND_REQUEST_REJECTED, Toast.LENGTH_SHORT);
		super.identifyUser(extrasObtained);
	...
	public void onFriendRequestRejectFailure() {
		...
		katwalk.toastMaker.toast(net.shiftinpower.activities.person.UserProfile.this, C.Errorz.FRIEND_REQUEST_NOT_REJECTED, Toast.LENGTH_SHORT);
		...
		if (personHasFriendRequestFromUs) {
			...
			bUserProfileActionButtonTwo.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					new FriendRequestSendAsync(UserProfile.this, UserProfile.this, currentlyLoggedInUser, personId).execute();
	...
	private void displayRespondToFriendRequestDialog() {
		...
		respondToFriendRequestDialog = new Dialog(UserProfile.this, R.style.no_title_dialog);
		...
		bDialogRespondToFriendRequestSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new FriendRequestAcceptAsync(UserProfile.this, UserProfile.this, personId, currentlyLoggedInUser).execute();
		...
		bDialogRespondToFriendRequestReject.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new FriendRequestRejectAsync(UserProfile.this, UserProfile.this, personId, currentlyLoggedInUser).execute();
				respondToFriendRequestDialog.dismiss();
	...
	private void displayCancelFriendRequestDialog() {
		...
		cancelFriendRequestDialog = new Dialog(UserProfile.this, R.style.no_title_dialog);
		...
		bDialogCancelFriendRequestSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new FriendRequestCancelAsync(UserProfile.this, UserProfile.this, currentlyLoggedInUser, personId).execute();
